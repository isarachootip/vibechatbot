...
export default function NewCategoryPage() {
    ...
    const handleSubmit = async (formData: FormData) => {
        setLoading(true);
        // Append image URL to formData manually since the input is controlled
        ...
        try {
            ...
            console.error(e);
            alert("Failed to create category: " + (e as Error).message);
            setLoading(false);
        }
    };
    ...
    return (
        <div className="space-y-6 max-w-lg mx-auto bg-white p-6 rounded-lg shadow-sm border">
            <div>
                ...
                <p className="text-sm text-gray-500">Add a new category with an image for the chatbot menu.</p>
            </div>
